...
export let MOCK_ANNOUNCEMENTS: Announcement[] = [
  ...
  },
  {
    ...
    body: 'The Central Field leadership is conducting district-level training for all local coordinators.',
    priority: 'NORMAL',
    category: 'TRAINING',
    publishedAt: '2026-05-15T14:30:00',
    author: 'Field President',
    authorRole: 'FIELD_LEADER',
    targetRole: 'DISTRICT_LEADER',
  ...
  },
  {
    ...
    authorRole: 'DISTRICT_LEADER',
    targetRole: 'CHURCH_LEADER',
  ...
  },
  {
    ...
    body: 'The MIS portal will be down for maintenance on Saturday from 2-4 AM.',
    priority: 'LOW',
    category: 'GENERAL',
    publishedAt: '2026-05-17T08:00:00',
    author: 'System Admin',
    authorRole: 'SUPER_ADMIN',
    targetRole: 'UNION_LEADER',
  ...
  {
    id: 'an6',
    title: 'Youth Ministry Volunteer Drive',
    body: 'Calling all volunteers to join the youth ministry outreach program this month.',
    priority: 'NORMAL',
    category: 'YOUTH',
    publishedAt: '2026-05-20T09:00:00',
    author: 'Ministry Leader Youth',
...
export const MOCK_ACHIEVEMENTS: AchievementItem[] = [
  ...
  },
  {
    ...
    submittedByRole: 'DISTRICT_LEADER',
  },
];
...
export let MOCK_MANAGED_USERS: ManagedUser[] = [
  ...
  {
    id: 'u4',
    name: 'District Coordinator Kigali',
    email: 'district-leader@mifem.rw',
  ...
  {
    id: 'u7',
    name: 'Ministry Leader Youth',
    email: 'ministry-leader@mifem.rw',
    role: 'MINISTRY_LEADER',
    status: 'ACTIVE',
    lastLogin: '2026-05-18T10:00:00',
    mfaEnabled: false,
    permissions: ['members.read', 'events.read', 'events.write', 'attendance.read'],
    unionId: 'UM1',
    fieldId: 'FR1',
    churchId: 'CH1',
    ministryId: 'MIN1',
  ...
  {
    id: 'u8',
    name: 'Volunteer Alice Mukamana',
    email: 'volunteer@mifem.rw',
    role: 'VOLUNTEER',
    status: 'ACTIVE',
    lastLogin: '2026-05-17T14:00:00',
    mfaEnabled: false,
    permissions: [],
    unionId: 'UM1',
    churchId: 'CH1',
